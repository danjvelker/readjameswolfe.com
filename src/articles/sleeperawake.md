...
Sleeping faith lives for its own comfort. It objects to disruption, quails from necessary confrontation, and excuses the sedentary pattern of inaction that defines most of its existence. It conforms to where it already lives, not transforming into something challenging. A sleeping faith yearns for the chains of Egypt, where at least they ate meat and fruit as slaves, and bucks away from the desert's call to adventure, where there is dust unending and gnawing hunger and pain unyielding and glory unimaginable.
